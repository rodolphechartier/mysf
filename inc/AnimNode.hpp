...
namespace mysf
{
	class AnimNode : public SceneNode
	{
		public:
			...
			explicit AnimNode(const sf::Texture & texture, const sf::Time & frameTime = sf::seconds(0.2f), bool isPaused = false, bool isLooped = true);
		...
		protected:
			...
			std::vector<sf::Vertex[4]> _vertices;
			sf::Color _color;
